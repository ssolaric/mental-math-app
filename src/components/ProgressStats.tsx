          ...
          <div className="flex items-baseline justify-between gap-6 mb-12">
            ...
            {hasData && (
              <button
                ...
                className={`text-sm font-medium underline underline-offset-4 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-graphite focus-visible:ring-offset-2 focus-visible:ring-offset-paper rounded-sm ${
                  resetArmed
                    ? "text-wrong decoration-wrong"
          ...
          {hasData ? (
            <>
              <section className="mb-14">
                <p className="text-sm font-medium uppercase tracking-[0.22em] text-graphite-light mb-4">
                  En total
                </p>
